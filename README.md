...
| Task Status Cycler      | `task-status-cycler`     |   1.3.3 | Toggle tasks and Pomodoros with recursive close and root-only reopen, bidirectionally retire and restore references, and reconcile Tasks dependency IDs. |
