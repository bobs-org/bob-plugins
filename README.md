...
`plugins/<id>/manifest.json` (e.g. `bob-navigation-hotkeys` is ahead of the others at `1.28.1`).
...
planner coverage, guarded counted writes, deletion behavior,
