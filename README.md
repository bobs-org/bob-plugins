...
| Bob Navigation Hotkeys  | `bob-navigation-hotkeys` |  1.13.6 | Open and manage related notes and tabs; `N<Ctrl+Shift+P>` edits the current task plus the next N real tasks, and `!` synchronizes visible task dependencies. |
