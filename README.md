...
`plugins/<id>/manifest.json` (e.g. `bob-navigation-hotkeys` is ahead of the others at `1.36.0`).
...
and merged-name split planner coverage, Pomodoro entry move/rename/merge planner coverage,
