...
| Task Status Cycler      | `task-status-cycler`     |   1.3.0 | Cycle task statuses, mark links under completed Pomodoros, retire references on closure, and reconcile Tasks dependency IDs. |
