...
| Bob Navigation Hotkeys  | `bob-navigation-hotkeys` |   1.6.0 | Open parent/alternate notes and set bullet properties, including local task dependencies with visible `**DEPENDS ON:**` `[[#^block-id]]` navigation links and `<Tab>` batch add/remove. |
