...
| Bob Navigation Hotkeys  | `bob-navigation-hotkeys` |  1.13.4 | Open and manage related notes and tabs; `!` synchronizes visible task dependencies and monotonically promotes Ready/Next targets to the parent task's stronger status. |
