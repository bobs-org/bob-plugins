...
`plugins/<id>/manifest.json` (e.g. `bob-navigation-hotkeys` is ahead of the others at `1.35.0`).
...
planner coverage, Pomodoro entry move/rename/merge planner coverage,
